  ...
  return (
    <section id="contact" className="py-20 bg-gradient-to-br from-white via-blue-50 to-white static-bg">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16">
          <div className="glass-card rounded-3xl shadow-2xl p-8 w-full aqua-glow bg-gradient-to-br from-blue-100/50 to-white/50">
            <h3 className="text-4xl lg:text-5xl font-bold text-gray-700 mb-6 text-center">Why choose otobrothers?</h3>
            <div className="grid md:grid-cols-2 gap-6">
